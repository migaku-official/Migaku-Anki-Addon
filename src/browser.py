...
def setup_browser_menu(browser: Browser):
    ...
    add_syntax_action.triggered.connect(
        lambda: AddRemoveSyntaxDialog.show_modal(
            browser.selectedNotes(), False, browser
        )
    )
    ...
    browser.form.menu_Notes.insertAction(
        browser.form.actionManage_Note_Types, add_syntax_action
    )
    browser.form.menu_Notes.insertAction(
        browser.form.actionManage_Note_Types, remove_syntax_action
    )
    browser.form.menu_Notes.insertAction(
        browser.form.actionManage_Note_Types, card_type_action
    )
    browser.form.menu_Notes.insertAction(
        browser.form.actionManage_Note_Types, definitions_action
    )
